...
router
  .route("/:id")
  .put(rate_limit(PRESETS.api), validate_object_id(), country_controller.update_country)
  .delete(rate_limit(PRESETS.api), validate_object_id(), country_controller.delete_country);
