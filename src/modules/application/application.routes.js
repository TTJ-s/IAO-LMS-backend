...
router
  .route("/:id")
  .get(rate_limit(PRESETS.public), validate_object_id(), application_controller.find_application)
  .put(rate_limit(PRESETS.api), validate_object_id(), application_controller.update_application)
  .patch(
